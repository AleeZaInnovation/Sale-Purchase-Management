              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div class="form-group">
                        ...
                        <select id="userRole" name="userRole" id="userRole" class="form-control @error('userRole') Invalid @enderror">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                        <label>Number</label>
                        <input type="mobile" name="mobile" class="form-control @error('mobile') Invalid @enderror">
                        @error('mobile ')
                        <strong class="alert alert-danger">{{ $message }}</strong>
                        @enderror
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <input type="designation" name="designation" class="form-control @error('designation') Invalid @enderror">
                        @error('designation ')
                        <strong class="alert alert-danger">{{ $message }}</strong>
                        @enderror
                  </div> 
                  ...
                  <div class="form-group">
                        <label>Gender</label>
                        <input type="text" name="gender" class="form-control @error('gender') Invalid @enderror">
                        @error('gender ')
                        <strong class="alert alert-danger">{{ $message }}</strong>
                        @enderror
                  </div>
