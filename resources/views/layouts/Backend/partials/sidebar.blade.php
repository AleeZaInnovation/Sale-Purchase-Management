    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        <div class="sidebar-brand-icon rotate-n-15">
          <img width="40" class="rounded-circle" src="{{ asset('public/assets/Backend/images/'. Auth::User()->image) }}">
        </div>
            ...
            <li class="nav-item">
              ...
              <div id="collapse1" class="{{ ($prefix == '/users')?'collapse show':'collapse' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item {{ ($route == 'users.view')?'active':'' }}" href="{{ route('users.view') }}">View All Team Member</a>
                </div>
              </div>
            </li>
            @endif
      ...
      <!-- Heading -->
         @if(Auth::User()->userRole=='Admin')
            ...
            <li class="nav-item">
              ...
              <div id="collapse1" class="{{ ($prefix == '/company')?'collapse show':'collapse' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item {{ ($route == 'company.view')?'active':'' }}" href="{{ route('company.view') }}">View All Company</a>
                </div>
              </div>
            </li>
            @endif
      ...
      <!-- Heading -->
            ...
            <li class="nav-item">
              ...
              <div id="collapse1" class="{{ ($prefix == '/profile')?'collapse show':'collapse' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item {{ ($route == 'profile.view')?'active':'' }}" href="{{ route('profile.view') }}">Your Profile </a>
                  <a class="collapse-item {{ ($route == 'profile.password.view')?'active':'' }}" href="{{ route('profile.password.view') }}"> Change Password </a>
                </div>
              </div>
            </li>
      <!-- Nav Item - Pages Collapse Menu -->
      ...
      <li class="nav-item">
        ...
        <div id="collapse2" class="{{ ($prefix == '/supplier')?'collapse show':'collapse' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ ($route == 'supplier.credit')?'active':'' }}" href="{{ route('supplier.credit') }}">Credit Suppliers</a>

            <a class="collapse-item {{ ($route == 'supplier.paid.list')?'active':'' }}" href="{{ route('supplier.paid.list') }}">Paid Suppliers</a>

            <a class="collapse-item {{ ($route == 'supplier.wais.report')?'active':'' }}" href="{{ route('supplier.wais.report') }}"> Suppliers Wais Report</a>
