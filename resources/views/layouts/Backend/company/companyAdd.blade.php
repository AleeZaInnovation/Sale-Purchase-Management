                ...
                <div class="tab-content p-0">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                          ...
                          <input type="text" name="name" class="form-control" rows="5">
                    </div>

                    <div class="form-group col-md-6">
                          <label for="mobile">Company Mobile</label>
                          <input type="text" name="mobile" class="form-control" rows="5">
                    </div>

                    <div class="form-group col-md-6">
                          <label for="address">Company Address</label>
                          <input type="text" name="address" class="form-control" rows="5">
                    </div>

                    <div class="form-group col-md-6">
                          <label for="email">Company Email</label>
                          <input type="email" name="email" class="form-control" rows="5">
                    </div>                 
