...
<head>
  ...
  <!-- select2 min css -->
  <link href="{{ asset('public/assets/Backend/select2/css/select2.min.css') }}" rel="stylesheet">
  <!--- extra page source ----->
  @stack('css')
</head>
...
<body id="page-top">
  ...
  <script src="{{ asset('public/assets/Backend/js/handlebars.min.js') }}"></script>
  <!--- Notify js Start --->
  <script src="{{ asset('public/assets/Backend/js/notify.js') }}"></script>
  <!-- Select2 js -->
  <script src="{{ asset('public/assets/Backend/select2/js/select2.min.js') }}"></script>
  @stack('js')
  @stack('ajax')
  <!---- Success Message -->
