...
@section('content')
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-dark">Supplier Credit Information:-</h4>
            </div>
            <div class="card-body">
             <form method="post" action="{{ route('supplier.credit.update', $payment->purchase_id) }}">
              @csrf
                <!--- Supplier Info start ---->
              ...
              <table class="table borderd" style="background: #e2e2e2;  color: black;" width="100%">
                ...
                <tbody>
                  ...
                  <tr class="text-center">
                    ...
                    <td>{{ $invoice_detail->buying_qty }}</td>
                    <td>{{ $invoice_detail->unit_price }}</td>
                    <td>{{ $invoice_detail->buying_price }}</td>
                  </tr>
                  @php
                  $subTotal += $invoice_detail->buying_price;
                  @endphp
                  @endforeach
                <tr class="text-center">
