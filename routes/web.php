...
// Supplier Route //
Route::group(['as'=>'supplier.', 'prefix'=>'supplier','namespace'=>'Backend', 'middleware'=>'test'],function(){
   ...
   Route::get('/credit','supplierController@supplierCredit')->name('credit');
   Route::get('/credit/pdf','supplierController@supplierCreditPdf')->name('credit.pdf');
   Route::get('/credit/edit/{purchase_id}', 'supplierController@supplierCreditEdit')->name('credit.edit');
   Route::post('/credit/update/{purchase_id}', 'supplierController@supplierCreditUpdate')->name('credit.update');
   Route::get('/credit/summery/pdf/{purchase_id}', 'supplierController@supplierCreditSummery')->name('credit.summery');
   Route::get('/paid/list','supplierController@supplierPaidList')->name('paid.list');
   Route::get('/paid/list/pdf','supplierController@supplierPaidListPdf')->name('paid.list.pdf');
   Route::get('/wais/report','supplierController@supplierWaisReport')->name('wais.report');
   Route::get('/credit/wais/pdf','supplierController@supplierCreditWaisPdf')->name('credit.wais.pdf');
   Route::get('/paid/wais/pdf','supplierController@supplierPaidWaisPdf')->name('paid.wais.pdf');
});
// Customers Route //
Route::group(['as'=>'customer.', 'prefix'=>'customer','namespace'=>'Backend', 'middleware'=>'test'],function(){
...
// Unit Route //
Route::group(['as'=>'unit.', 'prefix'=>'unit','namespace'=>'Backend', 'middleware'=>'test'],function(){
...
// Category Route //
Route::group(['as'=>'category.', 'prefix'=>'category','namespace'=>'Backend', 'middleware'=>'test'],function(){
...
// Products Route //
Route::group(['as'=>'products.', 'prefix'=>'products','namespace'=>'Backend', 'middleware'=>'test'],function(){
...
// Purchase Route //
Route::group(['as'=>'purchase.', 'prefix'=>'purchase','namespace'=>'Backend', 'middleware'=>'test'],function(){
   ...
   Route::post('/approve/process/{id}','purchaseController@approveprocesses')->name('approve.process');
...
// Invocie Route //
Route::group(['as'=>'invoice.', 'prefix'=>'invoice','namespace'=>'Backend', 'middleware'=>'test'],function(){
...
// Stock Route //
Route::group(['as'=>'stock.', 'prefix'=>'stock','namespace'=>'Backend', 'middleware'=>'test'],function(){
...
// Company Route //
Route::group(['as'=>'company.', 'prefix'=>'company','namespace'=>'Backend', 'middleware'=>'test'],function(){
   Route::get('/view','CompanyController@view')->name('view');
